...
def create_monitoring_code(
    ...
    monitoring_code = textwrap.dedent(f'''
    import gc
    import time
    import sys
    import os
    ...
    class GCMonitor:
        ...
        NO I/O, NO memory checks, NO object scanning during runtime.
        """
        ...
        def __init__(self):
            ...
            # Event buffer: list of tuples (rel_time, generation, duration_ms, collected, uncollectable)
            self._event_buffer = []
            ...
            self.log_file = {repr(log_file) if log_file else None}
            self.log_handle = None
            self.alert_threshold_ms = {alert_threshold_ms}
            self.flamegraph_file = {repr(flamegraph_file) if flamegraph_file else None}
            ...
            # Statistics (computed at shutdown from buffer)
            self.stats = {{
                'total_collections': 0,
            ...
            # Enable GC debugging if needed (acceptable at init time)
        ...
        def _log_message(self, msg):
            """Log message to stderr and optionally to file - ONLY at shutdown"""
        ...
        def _record_flamegraph_sample(self, generation, duration_ms, relative_time):
            """Record flamegraph sample - called at shutdown"""
        ...
        def stop_monitoring(self):
            ...
            # Open log file if specified (deferred until shutdown)
            if self.log_file:
    ...
    try:
        ...
        # Stop monitoring and show stats (ALL I/O happens here)
